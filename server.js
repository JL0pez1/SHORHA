...
const nominaRoutes = require('./routes/nominaRoutes'); // Asegúrate que este es el archivo correcto
...
secret: process.env.SESSION_SECRET || 'SORHA_SESSION_SECRET_MUY_SEGURO_CAMBIAME',
...
app.use('/api/nomina', nominaRoutes); // Correctamente montado
...
console.log(`404 Intentando acceder a: ${req.originalUrl}`);
